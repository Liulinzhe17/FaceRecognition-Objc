...
MTCNN::MTCNN()
{
    NSString *det1BinPath = [[NSBundle mainBundle] pathForResource:@"det1" ofType:@"bin" inDirectory:@"res"];
    NSString *det2BinPath = [[NSBundle mainBundle] pathForResource:@"det2" ofType:@"bin" inDirectory:@"res"];
    NSString *det3BinPath = [[NSBundle mainBundle] pathForResource:@"det3" ofType:@"bin" inDirectory:@"res"];
    
    NSString *det1ParamPath = [[NSBundle mainBundle] pathForResource:@"det1" ofType:@"param" inDirectory:@"res"];
    NSString *det2ParamPath = [[NSBundle mainBundle] pathForResource:@"det2" ofType:@"param" inDirectory:@"res"];
    NSString *det3ParamPath = [[NSBundle mainBundle] pathForResource:@"det3" ofType:@"param" inDirectory:@"res"];
...
Recognize::Recognize()
{
    NSString *facenetBinPath = [[NSBundle mainBundle] pathForResource:@"ncnn" ofType:@"bin" inDirectory:@"res"];
    NSString *facenetParamPath = [[NSBundle mainBundle] pathForResource:@"ncnn" ofType:@"param" inDirectory:@"res"];
